...
import static com.conexia.qa.emssanar.user_interfaces.CommonPage.ACEPTAR;
import static com.conexia.qa.emssanar.user_interfaces.NegociacionPage.COMPLEJIDAD;
import static com.conexia.qa.emssanar.user_interfaces.NegociacionPage.COMPLEJIDAD_SELECCION;
import static com.conexia.qa.emssanar.user_interfaces.NegociacionPage.CREAR_NEGOCIACION;
import static com.conexia.qa.emssanar.user_interfaces.NegociacionPage.MODALIDAD_NEGOCIACION;
import static com.conexia.qa.emssanar.user_interfaces.NegociacionPage.MODALIDAD_NEGOCIACION_SELECCION;
import static com.conexia.qa.emssanar.user_interfaces.NegociacionPage.MODALIDAD_REGIMEN_SELECCION;
import static com.conexia.qa.emssanar.user_interfaces.NegociacionPage.POBLACION;
import static com.conexia.qa.emssanar.user_interfaces.NegociacionPage.REGIMEN_NEGOCIACION;
...
public class CreaLaBaseDeNegociacion implements Task {
	...
	@Override
	@Step("{0} Se crea la base con datos de la Negociación")
	...
	public static CreaLaBaseDeNegociacion conLosDatos() {
		return Tasks.instrumented(CreaLaBaseDeNegociacion.class, traerNegociacionPrestador().getModalidad(),
				traerNegociacionPrestador().getRegimen(), traerNegociacionPrestador().getPoblacion(),
