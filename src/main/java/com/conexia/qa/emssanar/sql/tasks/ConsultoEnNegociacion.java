package com.conexia.qa.emssanar.sql.tasks;
...
import com.conexia.qa.emssanar.interactions.TomarEvidencia;
import com.conexia.qa.emssanar.sql.modelos.NegociacionMedicamento;
import com.conexia.qa.emssanar.sql.modelos.NegociacionProcedimiento;
import com.conexia.qa.emssanar.sql.utilitario.ConexionBD;
...
public class ConsultoEnNegociacion implements Task {
	...
	public ConsultoEnNegociacion(String consulta, String porNroNegociacion, String tecnologia) {
		...
		this.procedimiento = NegociacionProcedimiento.traerNegociacionProcedimiento();
		this.medicamento = NegociacionMedicamento.traerNegociacionMedicamento();
		this.respuesta = "";
		this.registros = 0;
	}
	...
	public static ConsultoEnNegociacion procedimientos(String porNroNegociacion) {
		...
		String consultaProcedimientos = ""
				+ "select distinct gs.nombre gropu_habilitacion, s.codigo||' - '||s.nombre servicio_habilitacion,tca.descripcion tarifario,nsr.porcentaje_contrato  "
